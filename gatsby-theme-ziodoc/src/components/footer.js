...
const Footer = () => {
  return (
    <div className="container max-w-full w-full bg-primary-700 text-primary-50 flex flex-col">
      ...
      <p className="flex w-full text-sm justify-center pb-4">Copyright © {year} - ZIO Maintainers - Built with <a
        className="ml-1 underline" href="https://www.gatsbyjs.com/">Gatsby</a></p>
    </div>
  )
}
